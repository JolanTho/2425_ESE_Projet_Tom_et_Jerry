...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB9     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(I2C_IMU_SCL_GPIO_Port, I2C_IMU_SCL_Pin);

    HAL_GPIO_DeInit(I2C_IMU_SDA_GPIO_Port, I2C_IMU_SDA_Pin);
  ...
  /* USER CODE END I2C3_MspDeInit 0 */
    ...
    PC11     ------> I2C3_SDA
    */
    HAL_GPIO_DeInit(I2C_MAIN_SCL_GPIO_Port, I2C_MAIN_SCL_Pin);

    HAL_GPIO_DeInit(I2C_MAIN_SDA_GPIO_Port, I2C_MAIN_SDA_Pin);
